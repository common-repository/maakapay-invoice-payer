 ...
 * @subpackage Maakapay_Wordpress/admin/partials
 */
        ...
        <div class="wp-core-ui">
            <form action="javascript:void(0)" id="maakapay-settings-form">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <label for="mail_address">Currency You will accept</label>
                        </th>
                        <td>
                            <input type="text" name="maakapay_accepting_currencies" value="<?php echo get_option('maakapay_accepting_currencies'); ?>" placeholder="NPR, USD" required>
                            <p class="description" id="maakapay_accepting_currencies">Please enter the currency code that you will accept in your website. <strong>If you support multiple currency then please enter them using comma seperated format. ie: NPR, USD, EUR, etc</strong></p>
                        </td>
                    </tr>
                    </tbody>
                </table>
