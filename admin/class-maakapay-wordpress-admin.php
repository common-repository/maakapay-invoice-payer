 ...
 * @subpackage Maakapay_Wordpress/admin
 */
 ...
 */
class Maakapay_Wordpress_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/maakapay-wordpress-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/maakapay-wordpress-admin.js', array( 'jquery' ), $this->version, false );
    ...
    public function maakapay_menu() {
        ...
        add_menu_page( 'Maakapy Transaction list', 'Maakapay', 'manage_options', 'maakapay-dashboard', array( $this, 'maakapay_dashboard' ), 'dashicons-analytics' );
    ...
    public function maakapay_dashboard() {
        ...
        if( $action == "maakapay-view" ) {
            ...
            require_once MAAKAPAY_PLUGIN_PATH . 'admin/partials/maakapay-admin-transaction-detail.php';  // include template.

        } else {

            require_once MAAKAPAY_PLUGIN_PATH . 'admin/partials/maakapay-wordpress-admin-display.php';  // include template.
    ...
    public function maakapay_settings() {
        ...
        require_once MAAKAPAY_PLUGIN_PATH . 'admin/partials/maakapay-admin-settings.php';  // include template.
