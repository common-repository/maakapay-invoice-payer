 ...
 * @subpackage Maakapay_Wordpress/public
 */
 ...
 */
class Maakapay_Wordpress_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Maakapay_Wordpress_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Maakapay_Wordpress_Loader will then create the relationship
        ...
        if ( $post->post_name == 'maakapay-form' || $post->post_name == 'maakapay-success' || $post->post_name == 'maakapay-cancel' || $post->post_name ==  'maakapay-decline' ) {
            ...
            wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/maakapay-wordpress-public.css', array(), $this->version, 'all');

            wp_enqueue_style('bootstrap', plugin_dir_url(__FILE__) . 'css/bootstrap.min.css', array(), $this->version, 'all');

            wp_enqueue_style('payment-form', plugin_dir_url(__FILE__) . 'css/maakapay-payment-form.css', array(), $this->version, 'all');
	...
	public function enqueue_scripts() {
        ...
        if ( $post->post_name == 'maakapay-form' || $post->post_name == 'maakapay-success' || $post->post_name == 'maakapay-cancel' || $post->post_name ==  'maakapay-decline' ) {
            ...
            wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/maakapay-wordpress-public.js', array('jquery'), $this->version, false);
    ...
    public function payment_page_template_handler() {
        ...
        if( $post->post_name == "maakapay-form" ) {
            ...
            $page_template = MAAKAPAY_PLUGIN_PATH . "public/partials/maakapay-public-payment-form.php";
        ...
        if( $post->post_name == "maakapay-success" ) {
            ...
            $page_template = MAAKAPAY_PLUGIN_PATH . "public/partials/maakapay-public-payment-success.php";
        ...
        if( $post->post_name == "maakapay-cancel" ) {
            ...
            $page_template = MAAKAPAY_PLUGIN_PATH . "public/partials/maakapay-public-payment-cancel.php";
        ...
        if( $post->post_name == "maakapay-decline" ) {
            ...
            $page_template = MAAKAPAY_PLUGIN_PATH . "public/partials/maakapay-public-payment-decline.php";
    ...
    public function handle_request() {
        ...
        $invoice_id = $this->validate( trim( sanitize_text_field( $_REQUEST[ 'invoice_number' ] ) ), 'invoice_number' );
        $currency = $this->validate( trim( sanitize_text_field( $_REQUEST[ 'currency_code' ] ) ), 'currency_code' );
