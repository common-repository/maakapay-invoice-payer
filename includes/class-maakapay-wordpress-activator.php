 ...
 */
class Maakapay_Wordpress_Activator {
    ...
    public static function activate()
    {
        ...
        add_option( 'maakapay_accepting_currencies', ( get_option( 'maakapay_accepting_currencies' ) ) ? get_option( 'maakapay_accepting_currencies' ) : "NPR" );
        self::create_pages();
    }
